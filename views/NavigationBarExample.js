  ...
  renderPage() {
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('android', 'Default')}
          topSeparator="full"
        />
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('android', 'Custom')}
          bottomSeparator="full"
        />
        {this.renderHeader('iOS')}
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('ios', 'Default')}
          topSeparator="full"
        />
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('ios', 'Custom')}
        />
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('ios', 'Back Button')}
          bottomSeparator="full"
        />
        {this.renderHeader('Auto')}
        <ListRow
          titlePlace="none"
          detail={this.renderDetail('auto', 'Link Button')}
          topSeparator="full"
          bottomSeparator="full"
        />
      </ScrollView>
